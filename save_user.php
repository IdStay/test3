...
$type = "user";//тип доступа делаем user.Смены типа и блока ток в админ панеле
...
exit ("<html><head><meta http-equiv='Refresh' content='2; URL=$_SERVER[HTTP_REFERER]'></head><body>Извините, введённый вами логин уже зарегистрирован. Введите другой логин.</body></html>"); //останавливаем выполнение сценариев
...
if ($result2=='TRUE')
{
    ...
    $message = "Здравствуйте! Спасибо за регистрацию на My blog.com\nВаш логин: ".$login."\n
    Перейдите по ссылке, чтобы активировать ваш аккаунт:\nhttp://localhost/test3/activation.php?login=".$login."&code=".$activation."\nС уважением,\n
    Администрация My blog.com";//содержание сообщение
